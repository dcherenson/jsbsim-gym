...
def _sample_controller_config(trial, base_config):
    return replace(
        base_config,
        track_accel_lateral_gain=_suggest_signed_magnitude(
            trial,
            "track_accel_lateral_gain",
            base_config.track_accel_lateral_gain,
            0.35,
            4.0,
        ),
        track_accel_heading_gain=_suggest_signed_magnitude(
            trial,
            "track_accel_heading_gain",
            base_config.track_accel_heading_gain,
            0.35,
            4.0,
        ),
        track_accel_lateral_rate_gain=trial.suggest_float("track_accel_lateral_rate_gain", -0.02, 0.02),
        track_accel_max_fps2=trial.suggest_float("track_accel_max_fps2", 12.0, 64.0),
        ...
        roll_max_rad=trial.suggest_float("roll_max_rad", 0.55, 1.35),
        pitch_nz_gain=_suggest_signed_magnitude(trial, "pitch_nz_gain", base_config.pitch_nz_gain, 0.35, 4.0),
        pitch_q_damping=_suggest_signed_magnitude(trial, "pitch_q_damping", base_config.pitch_q_damping, 0.2, 5.0),
        nz_altitude_gain=trial.suggest_float("nz_altitude_gain", 0.0, 0.0020),
        nz_altitude_max_bias=trial.suggest_float("nz_altitude_max_bias", 0.05, 0.8),
        nz_min_cmd=trial.suggest_float("nz_min_cmd", 0.6, 1.1),
        nz_max_cmd=trial.suggest_float("nz_max_cmd", 1.5, 6.0),
        yaw_rate_damping=_suggest_signed_magnitude(trial, "yaw_rate_damping", base_config.yaw_rate_damping, 0.2, 5.0),
        yaw_ny_gain=_suggest_signed_magnitude(trial, "yaw_ny_gain", base_config.yaw_ny_gain, 0.2, 8.0),
