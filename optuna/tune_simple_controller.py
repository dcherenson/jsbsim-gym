...
def _sample_controller_config(trial, base_config):
    return replace(
        ...
        track_accel_lateral_rate_gain=_suggest_signed_range(
            trial,
            "track_accel_lateral_rate_gain",
            base_config.track_accel_lateral_rate_gain,
            1.0e-4,
            0.02,
        ),
        ...
        nz_altitude_gain=trial.suggest_float("nz_altitude_gain", 1.0e-6, 0.0020),
        nz_vrate_gain=trial.suggest_float("nz_vrate_gain", 1.0e-5, 0.05, log=True),
