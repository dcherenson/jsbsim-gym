...
DEFAULT_ACTION_LOW = MPPI_DEFAULT_ACTION_LOW
DEFAULT_ACTION_HIGH = MPPI_DEFAULT_ACTION_HIGH
DEFAULT_CONTOUR_WEIGHT = MPPI_DEFAULT_CONTOUR_WEIGHT
DEFAULT_LAG_WEIGHT = MPPI_DEFAULT_LAG_WEIGHT
DEFAULT_PROGRESS_REWARD_WEIGHT = MPPI_DEFAULT_PROGRESS_REWARD_WEIGHT
DEFAULT_VIRTUAL_SPEED_WEIGHT = MPPI_DEFAULT_VIRTUAL_SPEED_WEIGHT
DEFAULT_TERRAIN_SAFE_CLEARANCE_FT = MPPI_DEFAULT_TERRAIN_SAFE_CLEARANCE_FT
DEFAULT_CONTROL_RATE_WEIGHTS = MPPI_DEFAULT_CONTROL_RATE_WEIGHTS
DEFAULT_ALPHA_LIMIT_RAD = MPPI_DEFAULT_ALPHA_LIMIT_RAD
DEFAULT_VIRTUAL_SPEED_NOISE_STD_FPS = MPPI_DEFAULT_VIRTUAL_SPEED_NOISE_STD_FPS
DEFAULT_VIRTUAL_SPEED_MIN_FPS = MPPI_DEFAULT_VIRTUAL_SPEED_MIN_FPS
DEFAULT_VIRTUAL_SPEED_MAX_FPS = MPPI_DEFAULT_VIRTUAL_SPEED_MAX_FPS
DEFAULT_VIRTUAL_SPEED_TRIM_FPS = MPPI_DEFAULT_VIRTUAL_SPEED_TRIM_FPS
