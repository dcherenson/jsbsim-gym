...
MPPI_DEFAULT_HORIZON = 40
MPPI_DEFAULT_NUM_SAMPLES = 4000
MPPI_DEFAULT_OPTIMIZATION_STEPS = 3
MPPI_DEFAULT_REPLAN_INTERVAL = 1
MPPI_DEFAULT_LAMBDA = 1.0
MPPI_DEFAULT_GAMMA = 0.05
MPPI_DEFAULT_ACTION_NOISE_STD = (0.5, 0.5, 0.5, 0.5)
MPPI_DEFAULT_ACTION_LOW = (-1.0, -1.0, -1.0, 0.0)
MPPI_DEFAULT_ACTION_HIGH = (1.0, 1.0, 1.0, 1.0)
...
MPPI_DEFAULT_DEBUG_NUM_TRAJECTORIES = 96
